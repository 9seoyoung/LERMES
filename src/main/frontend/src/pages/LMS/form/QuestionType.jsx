...
export const QuestionType = forwardRef(function QuestionType({ q, dispatch, qNum }, ref) {
      ...
      <div className="qCont">
        ...
        {(q.type === "single" || q.type === "multiple") && (
          <div className="multipleSet">
            {/* <div style={{ marginBottom: 8, fontWeight: 600 }}>답변</div> */}
            {q.options.map((opt) => {
