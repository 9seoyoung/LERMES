              ...
              return (
                <div className={styles.listContainer} key={`list-${idx}`}>
                  ...
                  >
                    {items.map((item, i) => {
                      // ✅ 아이템별 상태를 여기서 계산
                      const itemStatus = String(item?.cohortSttsNm ?? v?.cohortSttsNm ?? "")
                        .trim()
                        .toUpperCase();
                      ...
                      return (
                        ...
                        >
                          <div className={itemStatus === "RECRUITING" ? styles.sttsCellOn : styles.sttsCellOff}>
                          ...
                          <div className={styles.crclmCell}>
                            <button
                              className={itemStatus === "RECRUITING" ? styles.applyBtnOn : styles.applyBtnOff}
                              type="button"
                              onClick={(e) => {
                                e.stopPropagation();
                                ...
                                if (!isLoggedIn) {
                                  ...
                                  navigate(`/visitorHome/applyRecruitPoster/${cohortSn}`);
                                  return;
                                }
                    ...
                    {openRow === idx && (
                      ...
                      >
                        {(() => {
                          const items2 = items;
                          const item =
                            openItem != null && items2[openItem] ? items2[openItem] : items2[0] ?? {};
                          ...
                          const attendStart = item?.attendStartTm ?? v?.attendStartTm;
                          ...
                          return (
                            <>
                              ...
                              <div className={styles.detailInfo}>
                                ...
                                {`${attendStart ? formatTime(attendStart) : "-"} ~ ${attendEnd ? formatTime(attendEnd) : "-"}`}
                              </div>
                              <div className={styles.detailInfo}>
