  ...
  return (
    <div className="boardPage">
      <div className="BigListBox">
        {manageState ?
          <ListEditTable
            tableHead={['순번', '이름', '이메일', '전화번호', '과정명 + 그룹명', '참여 상태', '수료 여부', '권한Lv', '접근 통제']}
  ...
  return (
    <div className="boardPage">
      <div className="BigListBox">
        {manageState ?
          <ListEditTable
            tableHead={['순번', '유형', '사유', '신청일', '승인여부', '첨부 파일']}
  ...
  return (
    <div className="boardPage">
      <div className="BigListBox">
        {manageState ?
          <ListEditTable
            tableHead={['순번', '이름', '입실시간', '퇴실시간', '출결상태', '특이사항']}
  ...
  return (
    <div className="boardPage">
      <div className="BigListBox">
        {manageState ?
          <ListEditTable
            tableHead={['그룹핑', '순번', '그룹명', '과정명', '모집기간', '교육기간', '교육장소','강사', '담당자', '교육 상태', '모집 폼 수정']}
  ...
  return (
    <div className="boardPage">
      <div className="BigListBox">
        {manageState ?
          <ListEditTable
            tableHead={['순번', '문서 유형', '이름', '그룹명', '발급일', '발급번호' ]}
