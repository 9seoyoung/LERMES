...
public class CertifiTemplateRequestDTO {
    @JsonIgnore
    private Integer certifiSn;      // 생성된 SN 받을용도
    private CertifiType certifiTypeNm;   // 증명서 유형 명(Enum만들기)EDU-> 교육진행확인서, COMPLETE->수료증 TB_CERTIFI_TYPE.CERTIFI_TYPE_NM
    ...
    @JsonIgnore
    private Integer coSn;            // 회사 일련번호 -> 백에서 넣을거임
}
